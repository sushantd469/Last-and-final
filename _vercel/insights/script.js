        ...
        o(),
            function() {
                let n = e => e,
                    ...
                    r = a.currentScript;
                if (t()) return;
                let i = (null == r ? void 0 : r.dataset.endpoint) || (null != r && r.src.includes("/va/") ? "/va" : "/_vercel/insights"),
                ...
                async function d(e) {
                    ...
                    let n = new URL(r.src),
                        i = n.pathname.split("/"),
                        o = i.pop();
                    return o && i.push("flags", o), n.pathname = i.join("/"),
                ...
                async function c({
                    ...
                    let y = v.includes(location.host),
                        g = {
                            o: h,
                            sv: "0.1.3",
                            sdkn: null != (f = null == r ? void 0 : r.dataset.sdkn) ? f : void 0,
                            sdkv: null != (p = null == r ? void 0 : r.dataset.sdkv) ? p : void 0,
                            ts: Date.now(),
                            ...l && {
                                dp: l
                            },
                            ...null != u && u.withReferrer && !y ? {
                                r: v
                            } : {},
                            ..."event" === t && o && {
                                en: o.name,
                ...
                let y = e(),
                    g = () => {
                        ...
                        window.va = function(e, t) {
                            "beforeSend" === e ? n = t : "event" === e ? t && p(t.name, t.data, t.options) : "pageview" === e && t && (t.route && (l = t.route), t.path && (s = t.path), f({
                                withReferrer: u
                            }), u = !1), "enableCookie" === e && h()
